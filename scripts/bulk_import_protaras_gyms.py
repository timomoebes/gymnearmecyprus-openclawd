"""
Bulk Import Script for Protaras Gyms
Imports all cleaned Protaras gyms from CSV.
"""
...
CLEAN_DATA_PATH = PROJECT_ROOT / "data" / "clean" / "protaras_gyms_clean.csv"
SQL_OUTPUT_PATH = PROJECT_ROOT / "scripts" / "bulk_import_protaras_gyms.sql"
...
def main():
    print("=" * 80)
    print("BULK IMPORT: Protaras Gyms")
    print("=" * 80)
    print()
    ...
    with open(SQL_OUTPUT_PATH, 'w', encoding='utf-8', errors='replace') as f:
        f.write("-- Bulk Import: Protaras Gyms\n")
