"""
Bulk Import Script for Ayia Napa Gyms
Imports all cleaned Ayia Napa gyms from CSV.
"""
...
CLEAN_DATA_PATH = PROJECT_ROOT / "data" / "clean" / "ayia_napa_gyms_clean.csv"
SQL_OUTPUT_PATH = PROJECT_ROOT / "scripts" / "bulk_import_ayia_napa_gyms.sql"
...
def main():
    print("=" * 80)
    print("BULK IMPORT: Ayia Napa Gyms")
    print("=" * 80)
    print()
    ...
    with open(SQL_OUTPUT_PATH, 'w', encoding='utf-8', errors='replace') as f:
        f.write("-- Bulk Import: Ayia Napa Gyms\n")
