"""
Bulk Import Script for Nicosia Gyms
Imports all 71 cleaned Nicosia gyms from CSV.
"""
...
SQL_OUTPUT_PATH = PROJECT_ROOT / "scripts" / "bulk_import_nicosia_gyms.sql"
...
def main():
    print("=" * 80)
    print("BULK IMPORT: Nicosia Gyms (71 gyms)")
    print("=" * 80)
    print()
    ...
    with open(SQL_OUTPUT_PATH, 'w', encoding='utf-8', errors='replace') as f:
        f.write("-- Bulk Import: Nicosia Gyms\n")
