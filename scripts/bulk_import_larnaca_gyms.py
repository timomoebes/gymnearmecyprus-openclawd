"""
Bulk Import Script for Larnaca Gyms
Imports all cleaned Larnaca gyms from CSV.
"""
...
CLEAN_DATA_PATH = PROJECT_ROOT / "data" / "clean" / "larnaca_gyms_clean.csv"
SQL_OUTPUT_PATH = PROJECT_ROOT / "scripts" / "bulk_import_larnaca_gyms.sql"
...
def main():
    print("=" * 80)
    print("BULK IMPORT: Larnaca Gyms")
    print("=" * 80)
    print()
    ...
    with open(SQL_OUTPUT_PATH, 'w', encoding='utf-8', errors='replace') as f:
        f.write("-- Bulk Import: Larnaca Gyms\n")
