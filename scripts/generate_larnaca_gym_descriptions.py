"""
Generate SEO-optimized descriptions for all Larnaca gyms
...
def generate_description(gym_row):
    ...
    # Extract city from address (usually "Larnaca, Cyprus" or neighborhood)
    city = 'Larnaca'
    if 'Larnaca' in address or 'Larnaka' in address:
        city = 'Larnaca'
    elif 'Makenzy' in address or 'Mackenzie' in address:
        city = 'Larnaca'  # Makenzy is part of Larnaca
    elif 'Pyla' in address or 'Dromolaxia' in address or 'Aradippou' in address:
        city = 'Larnaca'  # These are Larnaca neighborhoods
...
def main():
    ...
    CLEAN_CSV_PATH = PROJECT_ROOT / "data" / "clean" / "larnaca_gyms_clean.csv"
    SQL_OUTPUT_PATH = PROJECT_ROOT / "scripts" / "update_larnaca_descriptions.sql"
    
    print("=" * 80)
    print("GENERATING SEO DESCRIPTIONS FOR LARNACA GYMS")
    print("=" * 80)
    print()
    ...
    with open(SQL_OUTPUT_PATH, 'w', encoding='utf-8') as f:
        f.write("-- Update SEO descriptions for Larnaca gyms\n")
