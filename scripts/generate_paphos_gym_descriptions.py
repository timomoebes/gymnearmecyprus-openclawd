"""
Generate SEO-optimized descriptions for all Paphos gyms
...
def generate_description(gym_row):
    ...
    # Extract city from address (usually "Paphos, Cyprus" or neighborhood)
    city = 'Paphos'
    if 'Paphos' in address or 'Pafos' in address:
        city = 'Paphos'
    elif 'Konia' in address or 'Coral Bay' in address or 'Peyia' in address:
        city = 'Paphos'  # These are Paphos neighborhoods
...
def main():
    ...
    CLEAN_CSV_PATH = PROJECT_ROOT / "data" / "clean" / "paphos_gyms_clean.csv"
    SQL_OUTPUT_PATH = PROJECT_ROOT / "scripts" / "update_paphos_descriptions.sql"
    
    print("=" * 80)
    print("GENERATING SEO DESCRIPTIONS FOR PAPHOS GYMS")
    print("=" * 80)
    print()
    ...
    with open(SQL_OUTPUT_PATH, 'w', encoding='utf-8') as f:
        f.write("-- Update SEO descriptions for Paphos gyms\n")
