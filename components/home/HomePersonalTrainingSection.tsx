...
interface HomePersonalTrainingSectionProps {
  personalTrainingGyms: Gym[];
  cities: City[];
}

export function HomePersonalTrainingSection({ personalTrainingGyms, cities }: HomePersonalTrainingSectionProps) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-text-light max-w-3xl mx-auto">
            Find certified personal trainers and one-on-one coaching across Cyprus. Compare studios and choose the right fit for your goals.
          </p>
        </div>

        {personalTrainingGyms.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            {personalTrainingGyms.slice(0, 3).map((gym) => {
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <User className="w-5 h-5 text-primary-blue flex-shrink-0 ml-2" />
                  </div>
        ...
        <div className="text-center">
          <Link href="/specialties/personal-training">
            <Button variant="outline" size="lg">
              View All Personal Training Gyms
